# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_fomantic.ipynb.

# %% auto 0
__all__ = ['fui_hdrs', 'HeroSegment', 'Segment', 'VerticalStripeSegment', 'Grid', 'Column']

# %% ../nbs/01_fomantic.ipynb 1
from fasthtml.common import *
from fastcore.meta import delegates

# %% ../nbs/01_fomantic.ipynb 2
fui_hdrs = [
